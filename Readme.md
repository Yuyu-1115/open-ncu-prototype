...
* **Stateful Navigation**: Utilizes an `IndexedStack` combined with multiple independent `Navigator`s. This ensures that users will not lose their scroll progress or page state when switching between Home, News, Portal, and Settings tabs.
